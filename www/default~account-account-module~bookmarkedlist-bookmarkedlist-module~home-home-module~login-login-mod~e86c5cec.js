(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~account-account-module~bookmarkedlist-bookmarkedlist-module~home-home-module~login-login-mod~e86c5cec"],{
...
/*!**************************************!*\
  !*** ./src/app/auth/auth.service.ts ***!
  \**************************************/
/*! exports provided: snapshotToRecipeArray, snapshotToFoodArray, AuthService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _FoodItem__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../FoodItem */ "./src/app/FoodItem.ts");
...
var snapshotToRecipeArray = function (snapshot) {
    ...
    snapshot.forEach(function (childSnapshot) {
        ...
        var newRecipe = new _Recipe__WEBPACK_IMPORTED_MODULE_5__["Recipe"](title, numServings, macros, prepTime, ingredients, steps, idx);
...
var snapshotToFoodArray = function (snapshot) {
    ...
    snapshot.forEach(function (childSnapshot) {
        ...
        var macros = _Recipe__WEBPACK_IMPORTED_MODULE_5__["Recipe"].parseMacros(item[FOOD_MACRO_INDEX]);
        var newFoodItem = new _FoodItem__WEBPACK_IMPORTED_MODULE_6__["FoodItem"](macros, title);
...
var AuthService = /** @class */ (function () {
    function AuthService(afAuth, router, navCtrl) {
        ...
        this.recipes = [];
        this.foodItems = [];
        this.recipeDB = firebase__WEBPACK_IMPORTED_MODULE_4__["database"]().ref('recipeSheet/');
        this.foodDB = firebase__WEBPACK_IMPORTED_MODULE_4__["database"]().ref('foodSheet/');
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        if (!(email.includes('u.boisestate.edu') ||
                            email.includes('boisestate.edu'))) return [3 /*break*/, 2];
    ...
    AuthService.prototype.accountFirstLastName = function (userName) {
    ...
    Object.defineProperty(AuthService.prototype, "foodList", {
        get: function () {
    ...
    AuthService.prototype.confirm_signup = function (email) {
        var user = firebase__WEBPACK_IMPORTED_MODULE_4__["auth"]().currentUser;
        user
